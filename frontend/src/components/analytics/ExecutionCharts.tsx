...
export const ExecutionVolumeChart: React.FC<{ data: VolumeDataPoint[] }> = ({ data }) => {
...
// ── Success Rate Chart ─────────────────────────────────────────────────────────
export const SuccessRateChart: React.FC<{ data: VolumeDataPoint[] }> = ({ data }) => {
  const formatted = data.map(d => ({
    date: fmtDate(d.bucket),
...
export const DurationChart: React.FC<{ data: VolumeDataPoint[] }> = ({ data }) => {
  const formatted = data.map(d => ({
    date: fmtDate(d.bucket),

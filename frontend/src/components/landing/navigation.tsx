      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            <a onClick={() => navigate("/login")} className={`cursor-pointer transition-all duration-500 ${isScrolled ? "text-xs text-foreground/70 hover:text-foreground" : "text-sm text-white/70 hover:text-white"}`}>
              Sign In
            </a>
            <Button
              size="sm"
              onClick={() => navigate("/register")}
              className={`rounded-full transition-all duration-500 ${isScrolled ? "bg-primary hover:bg-primary/90 text-black px-4 h-8 text-xs" : "bg-primary hover:bg-primary/90 text-black px-6"}`}
            >
              Get Started
            </Button>
          </div>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <Button 
              className="flex-1 bg-primary text-black rounded-full h-14 text-base hover:bg-primary/90"

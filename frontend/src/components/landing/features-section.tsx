...
const features = [
  {
    number: "01",
    title: "AIChat",
    description: "Intelligent conversation engine with context awareness. Deploy AI-powered chat interfaces that understand and respond naturally to user queries.",
    stats: { value: "24/7", label: "availability" },
  },
  {
    number: "02",
    title: "AutoProducer",
    description: "Automated content generation at scale. Create, optimize, and publish content across multiple channels with AI-powered workflows.",
    stats: { value: "10x", label: "faster production" },
  },
  {
    number: "03",
    title: "AnalyticsCenter",
    description: "Real-time data analysis and insights. Process complex datasets and generate actionable intelligence automatically.",
    stats: { value: "100%", label: "uptime" },
  },
  {
    number: "04",
    title: "AutonomousOps",
    description: "Self-managing operational workflows. Automate routine tasks, monitoring, and incident response without manual intervention.",
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            <div className="lg:col-span-7">
              ...
              >
                Powerful
                <br />
                <span className="text-primary">AI Projects.</span>
              </h2>
            </div>

...
const PLATFORMS = [
  ...
  { id: "youtube",  label: "YouTube",  icon: "🔴", color: "#FF0000", desc: "Manage YouTube content", fields: [] },
  { id: "facebook", label: "Facebook", icon: "🔵", color: "#1877F2", desc: "Facebook Graph API", fields: [] },

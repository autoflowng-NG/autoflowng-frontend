...
function NodeCard({ node, kind, color }: { node: any; kind: string; color: string }) {
  return (
    <div style={{ display: "flex", alignItems: "flex-start", gap: 12, padding: "12px 14px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 10 }}>
      <span style={{ fontSize: 9, fontWeight: 700, color, background: color + "18", borderRadius: 6, padding: "3px 7px", fontFamily: "'DM Mono',monospace", flexShrink: 0, marginTop: 1 }}>{kind.toUpperCase()}</span>
      <div>
        <div style={{ fontSize: 13, fontWeight: 600, color: "#E8EEFF", marginBottom: 2 }}>{node.label}</div>

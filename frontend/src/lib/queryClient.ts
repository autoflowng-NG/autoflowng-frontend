...
export const queryKeys = {
  ...
  payoutBanks:   ["wallet", "payout-account", "banks"] as const,
  demoVideosPublic: ["public", "demo-videos"] as const,
  adminDemoVideos:  ["admin", "demo-videos"] as const,
  adminAffiliates:  (status?: string) => ["super-admin", "affiliates", status] as const,
...
export const invalidate = {
  ...
  payoutAccount: () => queryClient.invalidateQueries({ queryKey: queryKeys.payoutAccount }),
  adminDemoVideos: () => queryClient.invalidateQueries({ queryKey: queryKeys.adminDemoVideos }),
  adminAffiliates: () => queryClient.invalidateQueries({ queryKey: ["super-admin", "affiliates"] }),
